...
export default async function handler(
  ...
  // TODO: make sure to clean the data before passing it into the model and make sure its valid according to the parameters of the create completion api function
